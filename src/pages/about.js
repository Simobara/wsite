...
import ProfilePict from "../../public/images/profile/PostPc.png";
      ...
      <main className="flex w-full flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-star xl:col-span-4 md:order-2 lg:col-span-8">
              <h2 className="mb-4 text-lg font-bold uppercase text-dark/75">
                Biography
              </h2>
              <p className="font-medium">{PageAboutSentence2}</p>
              <p className="my-4 font-medium">{PageAboutSentence3}</p>
              <p className="font-medium">{PageAboutSentence4}</p>
            </div>
